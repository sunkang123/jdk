...
public class AddressBookReader01 {
    public static void main(String[] argv) {
        ...
        argv = new String[]{"D:\\Eclipse2018Data\\personProject\\jdk\\java-jaxp\\src\\main\\java\\com\\java\\jaxp\\xslt\\data\\PersonalAddressBook.ldif"};
        // Check the arguments
        if (argv.length != 1) {
